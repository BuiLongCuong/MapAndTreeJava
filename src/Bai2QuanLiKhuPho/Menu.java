...
public class Menu {
    ...
    public void showMainMenu() {
        int choice;
        do {
            System.out.println("==== Bai2QuanLiKhuPho.Menu Khu Phố =====\n" +
                    "1. Thêm hộ gia đình.\n" +
    ...
    public void showMenuPerson(Family family) {
        int choice;
        do {
            System.out.println(" === Bai2QuanLiKhuPho.Menu của nhà số " + family.getNumberHouse() + "=== \n" +
                    "      1. Thêm người \n" +
                    "      2. Hiển thị người\n" +
                    "      0. Thoát\n");
    ...
    public void menuAddPerson(Family family) {
        System.out.println("=== Bai2QuanLiKhuPho.Menu Thêm người ====");
